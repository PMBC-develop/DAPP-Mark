...
PMBC DAPP Market is a website that allows users to create DAPPs on blockchain in medical data analysis field and list Products for sale. Other users can purchase these products, facilitated by a deposit-based Smart Contract escrow.
